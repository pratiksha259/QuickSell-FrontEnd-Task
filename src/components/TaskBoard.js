...
import { ReactComponent as Hp } from '../icons_FEtask/Img - High Priority.svg';
import { ReactComponent as Lp } from '../icons_FEtask/Img - Low Priority.svg';
import { ReactComponent as Mp } from '../icons_FEtask/Img - Medium Priority.svg';
import { ReactComponent as Up } from '../icons_FEtask/SVG - Urgent Priority colour.svg';
//import { ReactComponent as Up } from '../icons_FEtask/SVG - Urgent Priority grey.svg';
import { ReactComponent as Np } from '../icons_FEtask/No-priority.svg';


const TaskBoard = ({ tasks, filterOption }) => {
          ...
          <div key={key} className="task-group">
           ...
           {tasks[key].map((task) => (
              <div key={task.id} className="task-item">
                ...
                {task.id!=="" && <TaskCard task={task} check={filterOption}/>}
              </div>
            ))}
           </div>
          </div>
